...
if (! function_exists('queue')) {
     ...
     *
     * @return Saeno\Support\Queue\Queue
     */
...
if (! function_exists('redirect')) {
     ...
     * @return Saeno\Support\Redirect\Redirect|mixed
     */
...
if (! function_exists('request')) {
     ...
     *
     * @return Saeno\Support\Phalcon\Http\Request
     */
    function request()
    {
...
if (! function_exists('route')) {
     ...
     * @return Saeno\Support\Phalcon\Mvc\Router|string
     */
...
if (! function_exists('url')) {
     ...
     * @return Saeno\Support\Phalcon\Mvc\URL|string
     */
...
if (! function_exists('view')) {
     ...
     * @param string $path
     * @param mixed $params
     * @return Saeno\Support\Phalcon\Mvc\View|string
     */
